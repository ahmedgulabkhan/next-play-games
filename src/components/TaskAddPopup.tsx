...
interface TaskAddPopupProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (taskData: { title: string; description?: string; priority: 'low' | 'normal' | 'high'; due_date?: string; labels?: string[]; assignees?: string[] }) => void;
  columnId: string;
  availableLabels?: Label[];
  availableTeamMembers?: TeamMember[];
}

export const TaskAddPopup: React.FC<TaskAddPopupProps> = ({
  isOpen,
  onClose,
  onSubmit,
  availableLabels,
